...
def parse_args():
    p = argparse.ArgumentParser(description="Generate samples with PCM-GAN (real data).")
    p.add_argument("--ckpt", type=str, default="pcm_gan_runs/pcm_gan.pt")
    p.add_argument("--outdir", type=str, default="pcm_gan_out")
...
def main():
    ...
    # use real data to sample conditions and daylight masks
